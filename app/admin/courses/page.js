          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted mt-1">{courses.length} total courses</p>
              </div>
            </div>
            <button
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-ink text-sm font-medium mb-2">Category</label>
                    <select
                  ...
                  <div>
                    <label className="block text-ink text-sm font-medium mb-2">Difficulty</label>
                    <select
                ...
                <div>
                  <label className="block text-ink text-sm font-medium mb-2">Class / Grade</label>
                  <select
                ...
                <div>
                  <label className="block text-ink text-sm font-medium mb-2">Status</label>
                  <select
